function Controller() {
    ...
    $.__views.content.add($.__views.loadingWrapper);
    ...
    $.__views.loadingWrapper.add($.__views.loadingLabel);
    $.__views.loading = Ti.UI.createImageView({
        right: "20dp",
        height: "80dp",
        width: "80dp",
        images: [ "/images/more0.png", "/images/more1.png", "/images/more2.png", "/images/more3.png", "/images/more4.png" ],
        id: "loading"
    });
    $.__views.loadingWrapper.add($.__views.loading);
